...
const UserDashboard = () => {
    ...
    axios
      ...
      .then((response) => {
        if (response.data.success == false) {
          ...
          console.log("profileinfo1", response.data.data);
        }
      })
      .catch((error) => {
        console.log(error);
  ...
  const getDashboardCount = () => {
    ...
    axios
      .post(
        `${BASE_URL}admin/userDashboardCount`,
        {
          // page: "1",
        },
        {
  ...
  useEffect(() => {
    ...
    // console.log("balance",profilecredit);
              ...
              <div className="col-xl-3 col-sm-6 same-card">
                <div className="card">
                  <div className="card-body depostit-card">
                    <div className="depostit-card-media d-flex justify-content-between style-1">
                      <div>
                        <h6>Total Reseller</h6>
                        <h3>{values.reseller}</h3>
                      </div>
                      <div className="icon-box bg-primary-light">
                        <svg
                          width={20}
              ...
              <div className="col-xl-3 col-sm-6 same-card">
                <div className="card">
                  <div className="card-body depostit-card">
                    <div className="depostit-card-media d-flex justify-content-between style-1">
                      <div>
                        <h6>Today Campaign</h6>
                        <h3>{values.comping}</h3>
                      </div>
                      <div className="icon-box bg-primary-light">
                        <svg
                          width={20}
                  ...
                  <table id="projects-tbl" className="table ItemsCheckboxSec">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <div className="d-flex align-items-center">
                            <img src="images/contacts/pic999.jpg" className="avatar rounded-circle" alt />
                            <p className="mb-0 ms-2">Elijah James</p>	
                          </div>
                        </td>
                        <td className="pe-0">
                      ...
                      <tr>
                        ...
                        <td className="pe-0">
                          <div className="tbl-progress-box">
                            <div className="progress">
                              <div className="progress-bar bg-danger" style={{width: '33%', height: 5, borderRadius: 4}} role="progressbar" />
                            </div>
