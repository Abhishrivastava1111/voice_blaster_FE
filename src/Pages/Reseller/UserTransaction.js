...
const UserTransactionLog = () => {
  ...
  const GetAlltransactionLogs = () => {
    ...
    axios
      .post(
        `${BASE_URL}admin/getUserTransaction`,
        { page: 1 },
        {
          headers: {
  ...
  const filteredItems = usertransacLog?.filter(
    (item) =>
      ...
      item.user_details[0].name.toLowerCase().includes(filterText.toLowerCase())
  );
  ...
  const columns = [
    ...
    // },
    {
      name: "Cusmoter Name",
      selector: (row) =>
        row.user_details.length > 0 ? row.user_details[0].name : "",
    },
    {
      name: "Credit Type",
        ...
        <div className="content-body">
          <div className="page-titles  ">
            <ol className="breadcrumb">
              <li>
                <h5 className="bc-title">Transaction log</h5>
              </li>
              ...
              <li className="breadcrumb-item active">
                <a href="javascript:void(0)">Transaction log:-</a>
              </li>
            </ol>
