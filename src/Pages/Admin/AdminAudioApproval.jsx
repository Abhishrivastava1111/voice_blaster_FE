...
function AdminAudioApproval() {
  ...
  var acceptReject = (audio_id, modifiedStatus) => {
    ...
    axios
      ...
      .then((response) => {
        var modifiedStatusAudios = audios.map((audio) => {
      ...
      <div>
        {audio.status != "pending" ? (
          <button
            ...
            onClick={() => {
              acceptReject(audio.audio_id, "pending");
            }}
          >
        ...
        {audio.status != "approved" ? (
          <button
            ...
            onClick={() => {
              acceptReject(audio.audio_id, "approved");
            }}
          >
        ...
        {audio.status != "rejected" ? (
          <button
            ...
            onClick={() => {
              acceptReject(audio.audio_id, "rejected");
            }}
          >
            ...
            <div className="card">
              ...
              <div className="card-body p-0">
                ...
                >
                  <thead>
                    <tr>
                      <th style={{ verticalAlign: "top", width: "5%" }}>
                        sr. no.
                      </th>
